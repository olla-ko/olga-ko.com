...
Пользователи в&nbsp;Эльбе в&nbsp;определенные сроки выполняют задачи по&nbsp;уплате налогов, взносов. Это обусловлено законодательством РФ. Здесь я&nbsp;расскажу про одну из&nbsp;таких задач&nbsp;&mdash; &laquo;Взносы ИП&nbsp;за&nbsp;себя&raquo;. Она была очень сложной для пользователей&nbsp;и, как следствие, для нашей техподдержки.
...
- Задача никак не&nbsp;требует подтвердить факт уплаты, не&nbsp;интересуется, а&nbsp;заплатил&nbsp;ли пользователь&nbsp;&mdash; он&nbsp;может ее&nbsp;просто завершить. С&nbsp;этим связана первая проблема.
...
![](../../img/portfolio/06-01-payments.png =705)

Между собой мы&nbsp;называем этот экран &laquo;промисами&raquo;.
...
В&nbsp;столбце &laquo;Уплачено&raquo; сразу подставлены те&nbsp;суммы, которые Эльба предлагала заплатить в&nbsp;прошлой задаче&nbsp;&mdash; это ожидания сервиса по&nbsp;оплате за&nbsp;предыдущий квартал, а&nbsp;не&nbsp;уже свершившиеся оплаты. Ранее проектировщик с&nbsp;командой думали, что так помогают пользователю не&nbsp;вспоминать те&nbsp;суммы, которые он&nbsp;должен был заплатить. По&nbsp;факту&nbsp;же Эльба не&nbsp;знает, сколько платил пользователь, да&nbsp;и&nbsp;платил&nbsp;ли вообще. Выглядит все так, будто эти суммы уже оплачены, Эльба про них знает и&nbsp;поэтому показывает в&nbsp;полях. Даже колонка называется &laquo;Уплачено&raquo;.

Пользователи воспринимали весь этот экран неверно. А&nbsp;если кто-то и&nbsp;понимал, о&nbsp;чем речь, им&nbsp;было очень сложно вспомнить, что они платили в&nbsp;прошлом квартале&nbsp;&mdash; сервис в&nbsp;этом не&nbsp;помогал. Из-за непонимания этого экрана пользователи хотели миновать его поскорее: вводили рандомные даты в&nbsp;поля, тем самым подтверждая факт оплаты, которой могло и&nbsp;не&nbsp;быть. От&nbsp;этого у&nbsp;них были неверные расчеты и&nbsp;ошибки в&nbsp;оплате взносов&nbsp;&mdash; налоговая сообщала им&nbsp;о&nbsp;долге. Пользователи недоумевали и&nbsp;звонили в&nbsp;техподдержку.
...
## Решение&nbsp;1&nbsp;&mdash; без промисов

Для меня решение про промисы было очевидным. Этот экран надо убирать. О&nbsp;том, что взносы надо заплатить, должна заботиться текущая задача по&nbsp;оплате, а&nbsp;не&nbsp;следующая. В&nbsp;этом ведь и&nbsp;есть суть задачки&nbsp;&mdash; помочь пользователю выполнить определенные действия в&nbsp;срок. Задача не&nbsp;должна завершаться легко и&nbsp;просто без оплаты. Она должна ждать появления списания по&nbsp;взносам в&nbsp;сервисе (платежку)&nbsp;&mdash; так Эльба будет уверена, что оплата и&nbsp;правда была. Пользователь&nbsp;же будет видеть, когда задача &laquo;Заплатить взносы&raquo; еще актуальна и&nbsp;недоделана, если еще нет оплаты.
...
![](../../img/portfolio/06-05-payments.png =565)
...
![](../../img/portfolio/06-06-payments.png =565)
...
![](../../img/portfolio/06-07-payments.png =898)

С&nbsp;одной стороны все рассчитанные суммы можно развернуть и&nbsp;посмотреть, из&nbsp;чего они складываются. С&nbsp;другой стороны&nbsp;&mdash; на&nbsp;финальном экране задачи пользователь видит платежки с&nbsp;совершенно другими суммами для оплаты. Почему так? Потому что каждая из&nbsp;сумм дробится на&nbsp;части и&nbsp;платится в&nbsp;разные фонды&nbsp;&mdash; пенсионный и&nbsp;ФФОМС.

### Как по&nbsp;закону

1. За&nbsp;2017 год пользователь должен заплатить 27&nbsp;990&nbsp;₽. Причем из&nbsp;них 23&nbsp;400&nbsp;₽ на&nbsp;страховую часть пенсии и&nbsp;4&nbsp;590&nbsp;₽ в&nbsp;ФФОМС. То&nbsp;есть две платежки в&nbsp;разные органы. Эти суммы нужно заплатить до&nbsp;31&nbsp;декабря 2017&nbsp;года.
2. Если у&nbsp;пользователя доход выше 300&nbsp;000&nbsp;₽ в&nbsp;год, то&nbsp;ему нужно заплатить еще&nbsp;1% с&nbsp;суммы, которая превышает эти 300&nbsp;000&nbsp;₽. Вся эта сумма идет на&nbsp;страховую часть пенсии, то&nbsp;есть в&nbsp;пенсионный фонд. Ее&nbsp;нужно заплатить до&nbsp;1&nbsp;апреля 2018&nbsp;года, если речь про взносы за&nbsp;2017&nbsp;год.
...
![](../../img/portfolio/06-08-payments.png =867)

Пробовала увязать прошлые оплаты и&nbsp;текущие расчеты:

![](../../img/portfolio/06-09-payments.png =959)

Пробовала показать, как эти суммы превращаются в&nbsp;две платежки:

![](../../img/portfolio/06-10-payments.png =737)

Но&nbsp;все это казалось очень сложным и&nbsp;запутанным.

Внезапно пришло понимание, что пользователю все эти расчеты вообще не&nbsp;нужны. Пользователям нравятся задачки с&nbsp;шагами, где только Далее &rarr; Далее &rarr; Готово. Большинство пользователей Эльбы доверяет расчетам и&nbsp;не&nbsp;хотят сложноты&nbsp;&mdash; все запутанное в&nbsp;Эльбе спрятано, в&nbsp;этом ее&nbsp;ценность. Расчеты&nbsp;же вызывают желание проверять их&nbsp;или интересоваться тем, как все посчиталось. А&nbsp;нет цифр&nbsp;&mdash; и&nbsp;нет проблем.
...
![](../../img/portfolio/06-11-payments.png =959)

Да&nbsp;и&nbsp;то, расчеты покажем справочно, сбоку&nbsp;&mdash; не&nbsp;надо на&nbsp;них смотреть и&nbsp;пытаться проверять. Они есть для тех, кто реально хочет что-то узнать и&nbsp;понять. Для большинства пользователей такой цели нет. Когда расчеты были в&nbsp;основной рабочей области, они будто заставляли раскрывать и&nbsp;проверять&nbsp;их, а&nbsp;тут уже и&nbsp;до&nbsp;разных вопросов недалеко. И&nbsp;до&nbsp;звонка в&nbsp;техподдержку. А&nbsp;так&nbsp;&mdash; это справочная информация, не&nbsp;особо напрягает.

Цифры на&nbsp;плашке можно разворачивать и&nbsp;посмотреть, из&nbsp;чего складываются:

![](../../img/portfolio/06-12-payments.png =436)
...
![](../../img/portfolio/06-13-payments.png =787)
...
Вот столбики количества обращений для 2017 и&nbsp;2018&nbsp;года, сгруппированные по&nbsp;месяцам. Задачу зарелизили 5&nbsp;июня 2018. Смотреть нужно на&nbsp;6&nbsp;и&nbsp;9&nbsp;столбик&nbsp;&mdash; взносы платят в&nbsp;июне и&nbsp;в&nbsp;сентябре. Видно, что красный столбик становится ниже синего:

![](../../img/portfolio/06-14-payments.png =600)
...
![](../../img/portfolio/06-15-payments.png =550)
